 ...
 * Invalid coordinates (NaN, Infinity, out-of-range) cause NSInvalidArgumentException
 * on iOS and silent corruption on Android.
 */
...
export default forwardRef(function MarkerWrapper({ image, children, coordinate, ...props }, ref) {
